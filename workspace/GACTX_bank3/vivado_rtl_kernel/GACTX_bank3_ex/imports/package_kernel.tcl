...
set kernel_name    "GACTX_bank3"
set kernel_vendor  "cva_stanford"
set kernel_library "ip"
...
proc edit_core {core} {
  ...
  set reg      [::ipx::add_register -quiet "sub_AA" $addr_block]
  set_property address_offset 0x010 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_AC" $addr_block]
  set_property address_offset 0x018 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_AG" $addr_block]
  set_property address_offset 0x020 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_AT" $addr_block]
  set_property address_offset 0x028 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_CC" $addr_block]
  set_property address_offset 0x030 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_CG" $addr_block]
  set_property address_offset 0x038 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_CT" $addr_block]
  set_property address_offset 0x040 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_GG" $addr_block]
  set_property address_offset 0x048 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_GT" $addr_block]
  set_property address_offset 0x050 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_TT" $addr_block]
  set_property address_offset 0x058 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "sub_N" $addr_block]
  set_property address_offset 0x060 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "gap_open" $addr_block]
  set_property address_offset 0x068 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "gap_extend" $addr_block]
  set_property address_offset 0x070 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "y_drop" $addr_block]
  set_property address_offset 0x078 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "align_fields" $addr_block]
  set_property address_offset 0x080 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "ref_len" $addr_block]
  set_property address_offset 0x088 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "query_len" $addr_block]
  set_property address_offset 0x090 $reg
  set_property size           [expr {4*8}]   $reg

  set reg      [::ipx::add_register -quiet "ref_offset" $addr_block]
  set_property address_offset 0x098 $reg
  set_property size           [expr {8*8}]   $reg

  set reg      [::ipx::add_register -quiet "query_offset" $addr_block]
  set_property address_offset 0x0a4 $reg
  set_property size           [expr {8*8}]   $reg

  set reg      [::ipx::add_register -quiet "ref_seq" $addr_block]
  set_property address_offset 0x0b0 $reg
  set_property size           [expr {8*8}]   $reg

  set reg      [::ipx::add_register -quiet "query_seq" $addr_block]
  set_property address_offset 0x0bc $reg
  set_property size           [expr {8*8}]   $reg

  set reg      [::ipx::add_register -quiet "tile_output" $addr_block]
  set_property address_offset 0x0c8 $reg
  set_property size           [expr {8*8}]   $reg

  set reg      [::ipx::add_register -quiet "tb_output" $addr_block]
